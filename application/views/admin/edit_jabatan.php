            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="gaji_pokok" id="gaji_pokok" placeholder="Enter Gaji Pokok" onkeyup="convertToRupiah(this);" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="uang_makan" id="uang_makan" placeholder="Enter Uang Makan "onkeyup="convertToRupiah(this);">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="tunjangan_jabatan" id="tunjangan_jabatan" placeholder="Enter Tunjangan Jabatan" onkeyup="convertToRupiah(this);" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="insentif" id="insentif" placeholder="Enter Insentif"onkeyup="convertToRupiah(this);" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="sewa_kendaraan" id="sewa_kendaraan" placeholder="Enter Sewa Kendaraan" onkeyup="convertToRupiah(this);" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="thr" id="thr" placeholder="Enter THR" onkeyup="convertToRupiah(this);">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="total_gaji" id="total_gaji" placeholder="Total Gaji Bersih" onkeyup="convertToRupiah(this);" readonly>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="bpjs" id="bpjs"  placeholder="Enter BPJS" onkeyup="convertToRupiah(this);">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="pajak" id="pajak" placeholder="Potongan Pajak Penghasilan" onkeyup="convertToRupiah(this);" readonly >
                </div>
              </div>
            </div>
