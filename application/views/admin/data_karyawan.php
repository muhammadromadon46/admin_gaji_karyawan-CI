                   ...
                   <?php foreach ($jabatan as $kar) : ?>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a class="btn btn-info btn-sm" href="<?php echo base_url('admin/edit_data/'.$kar->id); ?>" title="Edit">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url('admin/hapus_karyawan/'.$kar->id); ?> "  onclick="return confirm('Are You really want to Delete ?');" title="Delete">
